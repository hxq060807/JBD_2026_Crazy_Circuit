...
#define ICM20602_SPC_PIN            (SPI2_SCLK_P15_3)                          // 硬件 SPI SCK 引脚
#define ICM20602_SDI_PIN            (SPI2_MOSI_P15_5)                          // 硬件 SPI MOSI 引脚
#define ICM20602_SDO_PIN            (SPI2_MISO_P15_7)                          // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define ICM20602_CS_PIN             (P15_1)                                    // CS 片选引脚
