/*************************************************
Copyright (C), 2016-2014, TYUT JBD .
File name: CH455.h
Author: TYUT JBD
...
KeyValue_enum CH455_GetOneKey_GPS(uint8 Show, int32 Hyper_Select);
KeyValue_enum CH455_GetOneKey_RT(uint8 Show, uint8 Point_Num, int32 Hyper);
